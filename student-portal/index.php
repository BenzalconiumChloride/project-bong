...
// Check if user is a student (access_level = 0)
if (isset($_SESSION['user_id'])) {
	...
	if ($stmt->rowCount() > 0) {
		...
		// If user is a teacher (access_level = 1), redirect to teacher portal
		if ($accessLevel == 1) {
		...
		// If access_level = 0 (student), allow access to continue
	} else {
